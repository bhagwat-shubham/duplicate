...
export default function Index() {
  ...
  const parserURL = parserData["driverslicense"];
  ...
  // console.log("Printing response", docAIResponse);

  // const textContent = docAIResponse?.document.text.split("\n") || [];
  // // const entityList = docAIResponse?.document.pages
  // const entityList = textContent.map((data, i) => {
  //   return (
      ...
      <div className="antialiased text-gray-600">
        {user && (
          <div>
            ...
            <Section
              title="Driver's License Parser"
              description="Upload .pdf, .jpeg or .png files"
            >
              <div className="my-2">
                For batch processing click{" "}
                <a href="/batch-process-drlicense" className="underline">
                  here
                </a>
              </div>
                  ...
                  {docAIResponse && (
                    <div>
                      <div className="mb-3">
                        ...
                        <div></div>
                        <div className="p-2 pb-1 border rounded h-64 overflow-auto">
                          {entityList}
                        </div>
                      </div>
                      <div className="">
