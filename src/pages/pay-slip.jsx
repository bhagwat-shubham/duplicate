...
export default function Index() {
  ...
  const parserURL = parserData["payslip"];
  ...
  // const [isHumanintheLoop, setisHumanintheLoop] = useState(false);
  // TODO: Use or remove
  console.log(firestoreProgress);

  // function humanintheloop() {
  //   if ((docAIResponse.humanReviewStatus.state = "IN_PROGRESS")) {
  //     setisHumanintheLoop(true);
  //   }
  // }
