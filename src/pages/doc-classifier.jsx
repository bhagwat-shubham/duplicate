...
import ProcessDocumentClassifier from "../components/docai/ProcessDocumentClassifier";
...
export default function Index() {
  ...
  const classifierUrl = parserData["classifier"];
  ...
  // const entityList = docAIResponse?.payload?.map((data, i) => {
  //   return (
  ...
  //         {" "}
  //         {docTitleDictionary[data.displayName]}{" "}
  //       </span>
  //       <span className=" inline-block  "> {data.classification.score} </span>
  //     </div>
  //   );
  // });
        ...
        {user && (
          <div>
            ...
            <Section
              ...
              description="Upload 1040, W2, driver's license or SSN files "
            >
              <div className="grid md:grid-cols-2  gap-10">
                <div
                  style={{ minHeight: "364px" }}
                  className="p-4  md:w-auto  border-gray-400 border rounded border-4 border-opacity-3"
                >
                  <ProcessDocumentClassifier
                ...
                <div className="p-4 md:w-auto border-gray-400 border rounded border-4 border-opacity-3">
                  ...
                  {docAIResponse && (
                    <div>
                      <div className="mb-3">
                        {docAIResponse && docAIResponse?.predictions && (
                          <div className="py-2">
                            <div>The uploaded document is classified as: </div>
                            <span className="text-5xl py-3 font-semibold">
                              {
                                docTitleDictionary[
                                  docAIResponse?.predictions[0].displayNames[0]
                                ]
                              }
                            </span>{" "}
                            <div>
                              ...
                              <span className="font-semibold">
                                {" "}
                                {(
                                  docAIResponse?.predictions[0].confidences[0] *
                                  100
                                ).toFixed(2)}
                                %
                              </span>{" "}
